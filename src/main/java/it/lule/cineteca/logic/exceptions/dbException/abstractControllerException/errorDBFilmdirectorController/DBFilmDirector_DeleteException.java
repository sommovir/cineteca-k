 ...
 * @author lele
 */
public class DBFilmDirector_DeleteException extends DBAbstractControllerException {

    public DBFilmDirector_DeleteException() {
        super(ErrorCodeEnum.DB_FILM_DIRECTOR_DELETE);
    }
}
