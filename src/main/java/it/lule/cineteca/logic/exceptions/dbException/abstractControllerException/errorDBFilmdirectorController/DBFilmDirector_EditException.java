 ...
 * @author lele
 */
public class DBFilmDirector_EditException extends DBAbstractControllerException {

    public DBFilmDirector_EditException() {
        super(ErrorCodeEnum.DB_FILM_DIRECTOR_EDIT);
    }
}
